...
<div className='about-contents'>
     <p>HOME <span style={{fontSize:'20px'}}><MdKeyboardArrowRight /></span> ABOUR US <span style={{fontSize:'20px'}}><MdKeyboardArrowRight /></span> </p>
                <h1>About Us</h1>
</div>
      ...
      <Container fluid className="about" style={{marginTop:'0px'}}>
        <Row>
          ...
          <Col id="about-2" style={{marginTop:'0px'}} className="col-lg-8 col-md-8 col-sm-12">
